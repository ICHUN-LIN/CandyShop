...
namespace CandyShop.Models
{
    public class AppDbContext:DbContext
    {
        ...
        /*Use as interface of Db and Object (table)*/
        ...
        {//happen when Modleing creating :DataBase inital setup and put data in model, 
            /*
             EF Core 提供三種設定 Model 方式：慣例 (Convension)、Fluent API 及 Data Annotation(資料註解，以 Attribute 形式加註於 Property)，有些功能支援多種設定方式，有些則只能透過 Fluent API 達成。 
             Fluent API 要寫在 DbContext.OnModelCreating()，例如：
